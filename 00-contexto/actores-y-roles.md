...
| **Visitante** | Persona sin cuenta que llega a la página de inicio pública (`EP-009`) desde un enlace o un buscador | Entender qué hace el producto, iniciar sesión si ya tiene acceso, o registrarse y crear su propia organización cliente (`HU-060`) |
