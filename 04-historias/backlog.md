...
| `HU-062` | [Configurar el aviso de privacidad de la organización cliente](EP-001-expediente-completo-a-mano/HU-062-configurar-el-aviso-de-privacidad.md) | Must | — implementada 2026-09-10 |
| `HU-063` | [Expiración y reactivación del acceso de la contraparte](EP-001-expediente-completo-a-mano/HU-063-expiracion-y-reactivacion-del-acceso.md) | Must | `PA-049` ✅ — vacío detectado en auditoría pre-despliegue 2026-09-11 |
